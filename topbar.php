                ...
                <li>
                    <div class="dropdown drp-user">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="assets/images/user/avatar-2.jpg" style="width: 40px;" class="img-radius" alt="User-Profile-Image">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                ...
                                <li><a href="javascript:" class="dropdown-item"><i class="feather icon-user"></i> Profile - EWSB ADMIN</a></li>
